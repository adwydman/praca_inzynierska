...
2.  Rozwój projektu – naprawienie błędu:
...
2.  **Komunikaty błędów** – niejasny i źle opisany błąd jest znacznym
...
W linijkach 1-10 zdefiniowana jest funkcja, która przyjmuje jeden
